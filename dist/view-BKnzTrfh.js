...
var ca = (i, e, t) => e in i ? ua(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t;
var n = (i, e, t) => ca(i, typeof e != "symbol" ? e + "" : e, t);
import { e as l, b as Se, i as h, T as w, I as Ke, c as Pe, C as da, g as ae } from "./casing-tDA94lCu.js";
var Ye;
Ye = l;
class A {
  constructor(e, t) {
...
class fa {
  ...
  /** @internal */
  build(e) {
    return new Pr(e, this.columns, this.nullsNotDistinctConfig, this.name);
  }
}
n(fa, et, "PgUniqueConstraintBuilder");
var tt;
tt = l;
class Pr {
  constructor(e, t, s, o) {
    ...
    this.table = e, this.columns = t, this.name = o ?? Sr(this.table, this.columns.map((a) => a.name)), this.nullsNotDistinct = s;
  }
  getName() {
    return this.name;
  }
}
n(Pr, tt, "PgUniqueConstraint");
function Me(i, e, t) {
...
function Tr(i) {
  return `{${i.map((e) => Array.isArray(e) ? Tr(e) : typeof e == "string" ? `"${e.replace(/\\/g, "\\\\").replace(/"/g, '\\"')}"` : `${e}`).join(",")}}`;
}
var it, st;
class $ extends (st = yr, it = l, st) {
  constructor() {
    super(...arguments);
    n(this, "foreignKeyConfigs", []);
  }
  array(t) {
    return new xr(this.config.name, this, t);
  }
  references(t, s = {}) {
...
class p extends (rt = A, nt = l, rt) {
  constructor(e, t) {
    t.uniqueName || (t.uniqueName = Sr(e, [t.name])), super(e, t), this.table = e;
  }
}
n(p, nt, "PgColumn");
var ot, at;
class Nr extends (at = p, ot = l, at) {
  constructor() {
    super(...arguments);
    n(this, "indexConfig", {
...
n(Nr, ot, "ExtraConfigColumn");
var lt, ut;
class xr extends (ut = $, lt = l, ut) {
  constructor(e, t, s) {
...
n(vr, ht, "PgEnumColumnBuilder");
var mt, gt;
class Br extends (gt = p, mt = l, gt) {
  constructor(t, s) {
    super(t, s);
...
n(U, pt, "Subquery");
var yt, wt;
class qr extends (wt = U, yt = l, wt) {
}
n(qr, yt, "WithSubquery");
const Ne = {
  startActiveSpan(i, e) {
    return e();
  }
  ...
  buildQueryFromSourceParams(e, t) {
    ...
    return pa(e.map((c) => {
      ...
      return h(c, k) ? { sql: u(m.value++, c), params: [c], typings: ["none"] } : h(c, G.Aliased) && c.fieldAlias !== void 0 ? { sql: a(c.fieldAlias), params: [] } : h(c, U) ? c._.isWith ? { sql: a(c._.alias), params: [] } : this.buildQueryFromSourceParams([
        ...
        new D(") "),
        new ue(c._.alias)
      ], s) : ga(c) ? c.schema ? { sql: a(c.schema) + "." + a(c.enumName), params: [] } : { sql: a(c.enumName), params: [] } : Dr(c) ? (N = c.shouldOmitSQLParens) != null && N.call(c) ? this.buildQueryFromSourceParams([c.getSQL()], s) : this.buildQueryFromSourceParams([
        new D("("),
        c.getSQL(),
        new D(")")
...
var Dt, Ct;
class Qr extends (Ct = Error, Dt = l, Ct) {
  constructor({ message: e, cause: t }) {
    super(e), this.name = "DrizzleError", this.cause = t;
  }
}
n(Qr, Dt, "DrizzleError");
function z(i, e) {
  return ya(e) && !Dr(i) && !h(i, Y) && !h(i, k) && !h(i, A) && !h(i, w) && !h(i, J) ? new Y(i, e) : i;
}
const Vr = (i, e) => r`${i} = ${z(e, i)}`, ba = (i, e) => r`${i} <> ${z(e, i)}`;
function xe(...i) {
  const e = i.filter(
    (t) => t !== void 0
  );
...
var Lt, jt;
class Ar extends (jt = ne, Lt = l, jt) {
  constructor(e) {
    super(e, "number", "PgBigInt53");
  }
  /** @internal */
  build(e) {
    return new zr(e, this.config);
  }
}
n(Ar, Lt, "PgBigInt53Builder");
var At, zt;
class zr extends (zt = p, At = l, zt) {
  getSQLType() {
    return "bigint";
  }
  mapFromDriverValue(e) {
...
n(zr, At, "PgBigInt53");
var It, Et;
class Ir extends (Et = ne, It = l, Et) {
  constructor(e) {
...
n(Ir, It, "PgBigInt64Builder");
var Ut, _t;
class Er extends (_t = p, Ut = l, _t) {
  getSQLType() {
    return "bigint";
  }
...
function Ua(i, e) {
  ...
  return s.mode === "number" ? new Ar(t) : new Ir(t);
}
var Kt, Mt;
class Ur extends (Mt = $, Kt = l, Mt) {
  constructor(e) {
...
n(Ur, Kt, "PgBigSerial53Builder");
var Rt, Jt;
class _r extends (Jt = p, Rt = l, Jt) {
  getSQLType() {
    return "bigserial";
  }
  mapFromDriverValue(e) {
...
n(_r, Rt, "PgBigSerial53");
var Wt, Gt;
class Kr extends (Gt = $, Wt = l, Gt) {
  constructor(e) {
...
n(Kr, Wt, "PgBigSerial64Builder");
var Ht, Yt;
class Mr extends (Yt = p, Ht = l, Yt) {
  getSQLType() {
    return "bigserial";
  }
  // eslint-disable-next-line unicorn/prefer-native-coercion-functions
...
n(Mr, Ht, "PgBigSerial64");
function _a(i, e) {
  const { name: t, config: s } = F(i, e);
  return s.mode === "number" ? new Ur(t) : new Kr(t);
}
var Xt, Zt;
class Rr extends (Zt = $, Xt = l, Zt) {
  constructor(e) {
...
n(Rr, Xt, "PgBooleanBuilder");
var kt, ei;
class Jr extends (ei = p, kt = l, ei) {
  getSQLType() {
    return "boolean";
  }
}
...
n(Wr, ti, "PgCharBuilder");
var si, ni;
class Gr extends (ni = p, si = l, ni) {
  constructor() {
    super(...arguments);
...
n(Hr, ri, "PgCidrBuilder");
var ai, li;
class Yr extends (li = p, ai = l, li) {
  getSQLType() {
    return "cidr";
  }
}
...
n(Xr, ui, "PgCustomColumnBuilder");
var di, hi;
class Zr extends (hi = p, di = l, hi) {
  constructor(t, s) {
    super(t, s);
    n(this, "sqlName");
    n(this, "mapTo");
...
function Wa(i, e) {
  const { name: t, config: s } = F(i, e);
  return (s == null ? void 0 : s.mode) === "date" ? new kr(t) : new eo(t);
}
var Ti, Ni;
class to extends (Ni = $, Ti = l, Ni) {
  constructor(e) {
...
n(to, Ti, "PgDoublePrecisionBuilder");
var xi, vi;
class io extends (vi = p, xi = l, vi) {
  getSQLType() {
...
n(io, xi, "PgDoublePrecision");
function Ga(i) {
  return new to(i ?? "");
}
var Bi, qi;
class so extends (qi = $, Bi = l, qi) {
  constructor(e) {
...
n(so, Bi, "PgInetBuilder");
var Di, Ci;
class no extends (Ci = p, Di = l, Ci) {
  getSQLType() {
    return "inet";
  }
}
...
var Fi, Oi;
class ro extends (Oi = ne, Fi = l, Oi) {
  constructor(e) {
...
n(ro, Fi, "PgIntegerBuilder");
var Qi, Vi;
class oo extends (Vi = p, Qi = l, Vi) {
  getSQLType() {
    return "integer";
  }
  mapFromDriverValue(e) {
...
n(ao, Li, "PgIntervalBuilder");
var Ai, zi;
class lo extends (zi = p, Ai = l, zi) {
  constructor() {
    super(...arguments);
...
n(ho, Wi, "PgLineBuilder");
var Hi, Yi;
class fo extends (Yi = p, Hi = l, Yi) {
  getSQLType() {
    return "line";
  }
  mapFromDriverValue(e) {
...
n(mo, Xi, "PgLineABCBuilder");
var ki, es;
class go extends (es = p, ki = l, es) {
  getSQLType() {
    return "line";
  }
  mapFromDriverValue(e) {
...
function el(i, e) {
  const { name: t, config: s } = F(i, e);
  return !(s != null && s.mode) || s.mode === "tuple" ? new ho(t) : new mo(t);
}
var ts, is;
class po extends (is = $, ts = l, is) {
  constructor(e) {
...
n(po, ts, "PgMacaddrBuilder");
var ss, ns;
class yo extends (ns = p, ss = l, ns) {
  getSQLType() {
    return "macaddr";
  }
}
...
n(wo, rs, "PgMacaddr8Builder");
var as, ls;
class bo extends (ls = p, as = l, ls) {
  getSQLType() {
    return "macaddr8";
  }
}
...
function sl(i, e) {
  const { name: t, config: s } = F(i, e);
  return new So(t, s == null ? void 0 : s.precision, s == null ? void 0 : s.scale);
}
var fs, ms;
class Po extends (ms = $, fs = l, ms) {
  constructor(e) {
...
n(Po, fs, "PgPointTupleBuilder");
var gs, ps;
class $o extends (ps = p, gs = l, ps) {
  getSQLType() {
    return "point";
  }
  mapFromDriverValue(e) {
...
n(To, ys, "PgPointObjectBuilder");
var bs, Ss;
class No extends (Ss = p, bs = l, Ss) {
  getSQLType() {
    return "point";
  }
  mapFromDriverValue(e) {
...
n(vo, Ps, "PgGeometryBuilder");
var Ts, Ns;
class Bo extends (Ns = p, Ts = l, Ns) {
  getSQLType() {
...
n(qo, xs, "PgGeometryObjectBuilder");
var Bs, qs;
class Do extends (qs = p, Bs = l, qs) {
  getSQLType() {
    return "geometry(point)";
  }
  mapFromDriverValue(e) {
...
n(Do, Bs, "PgGeometryObject");
function ol(i, e) {
  const { name: t, config: s } = F(i, e);
  return !(s != null && s.mode) || s.mode === "tuple" ? new vo(t) : new qo(t);
}
var Ds, Cs;
class Co extends (Cs = $, Ds = l, Cs) {
  constructor(e, t) {
...
n(Co, Ds, "PgRealBuilder");
var Fs, Os;
class Fo extends (Os = p, Fs = l, Os) {
  constructor(t, s) {
    super(t, s);
...
n(Oo, Qs, "PgSerialBuilder");
var Ls, js;
class Qo extends (js = p, Ls = l, js) {
  getSQLType() {
    return "serial";
  }
}
...
var As, zs;
class Vo extends (zs = ne, As = l, zs) {
  constructor(e) {
...
n(Vo, As, "PgSmallIntBuilder");
var Is, Es;
class Lo extends (Es = p, Is = l, Es) {
  constructor() {
    super(...arguments);
...
n(jo, Us, "PgSmallSerialBuilder");
var Ks, Ms;
class Ao extends (Ms = p, Ks = l, Ms) {
  getSQLType() {
    return "smallserial";
  }
}
n(Ao, Ks, "PgSmallSerial");
function cl(i) {
  return new jo(i ?? "");
}
var Rs, Js;
class zo extends (Js = $, Rs = l, Js) {
  constructor(e, t) {
...
n(zo, Rs, "PgTextBuilder");
var Ws, Gs;
class Io extends (Gs = p, Ws = l, Gs) {
  constructor() {
    super(...arguments);
    n(this, "enumValues", this.config.enumValues);
  }
...
function hl(i, e = {}) {
  const { name: t, config: s } = F(i, e);
  return new Eo(t, s.withTimezone ?? !1, s.precision);
}
var ks, en;
class Uo extends (en = X, ks = l, en) {
  constructor(e, t, s) {
...
n(_o, nn, "PgTimestampStringBuilder");
var on, an;
...
function fl(i, e = {}) {
  const { name: t, config: s } = F(i, e);
  return (s == null ? void 0 : s.mode) === "string" ? new _o(t, s.withTimezone ?? !1, s.precision) : new Uo(t, (s == null ? void 0 : s.withTimezone) ?? !1, s == null ? void 0 : s.precision);
}
var ln, un;
class Ko extends (un = $, ln = l, un) {
  constructor(e) {
...
n(Mo, hn, "PgVarcharBuilder");
var mn, gn;
class Ro extends (gn = p, mn = l, gn) {
  constructor() {
    super(...arguments);
    n(this, "length", this.config.length);
    n(this, "enumValues", this.config.enumValues);
...
n(Jo, pn, "PgBinaryVectorBuilder");
var wn, bn;
class Wo extends (bn = p, wn = l, bn) {
  constructor() {
    super(...arguments);
...
n(Wo, wn, "PgBinaryVector");
function pl(i, e) {
  const { name: t, config: s } = F(i, e);
  return new Jo(t, s);
}
var Sn, Pn;
class Go extends (Pn = $, Sn = l, Pn) {
  constructor(e, t) {
...
n(Go, Sn, "PgHalfVectorBuilder");
var $n, Tn;
class Ho extends (Tn = p, $n = l, Tn) {
  constructor() {
    super(...arguments);
    n(this, "dimensions", this.config.dimensions);
  }
...
n(Yo, Nn, "PgSparseVectorBuilder");
var vn, Bn;
class Xo extends (Bn = p, vn = l, Bn) {
  constructor() {
    super(...arguments);
    n(this, "dimensions", this.config.dimensions);
  }
...
n(Xo, vn, "PgSparseVector");
function wl(i, e) {
  const { name: t, config: s } = F(i, e);
  return new Yo(t, s);
}
var qn, Dn;
class Zo extends (Dn = $, qn = l, Dn) {
  constructor(e, t) {
...
n(Zo, qn, "PgVectorBuilder");
var Cn, Fn;
class ko extends (Fn = p, Cn = l, Fn) {
  constructor() {
    super(...arguments);
    n(this, "dimensions", this.config.dimensions);
  }
...
var On, Qn, Vn, Ln, jn;
class E extends (jn = w, Ln = l, Vn = ve, Qn = We, On = w.Symbol.ExtraConfigBuilder, jn) {
  constructor() {
    super(...arguments);
    /**@internal */
    n(this, Vn, []);
...
const ea = (i, e, t) => Pl(i, e, t, void 0);
var An;
An = l;
class ze {
  constructor(e, t, s) {
...
n(ze, An, "Relation");
var zn, In;
const fe = class fe extends (In = ze, zn = l, In) {
  constructor(e, t, s, o) {
...
let te = fe;
var En, Un;
const me = class me extends (Un = ze, En = l, Un) {
  constructor(e, t, s) {
...
n(ge, _n, "SelectionProxyHandler");
let L = ge;
var Kn, Mn;
class re extends (Mn = J, Kn = l, Mn) {
}
n(re, Kn, "PgViewBase");
var Rn;
Rn = l;
class le {
  ...
  buildRelationalQueryWithoutPK({
    ...
    if (c.length === 0)
      throw new Qr({ message: `No fields selected for table "${a.tsName}" ("${d}")` });
    let B;
    if (x = xe(m, x), f) {
...
n(W, Wn, "PgSelectBuilder");
var Gn, Hn;
class ia extends (Hn = ta, Gn = l, Hn) {
  ...
  createSetOperator(t, s) {
    return (o) => {
      ...
      if (!jr(this.getSelectedFields(), a.getSelectedFields()))
        throw new Error(
...
n(ia, Gn, "PgSelectQueryBuilder");
var Yn, Xn;
class Ie extends (Xn = ia, Yn = l, Xn) {
  constructor() {
    super(...arguments);
    n(this, "authToken");
...
const xl = () => ({
  ...
  exceptAll: Fl
}), vl = Z("union", !1), Bl = Z("union", !0), ql = Z("intersect", !1), Dl = Z("intersect", !0), Cl = Z("except", !1), Fl = Z("except", !0);
var Zn;
Zn = l;
class Ee {
  constructor(e) {
...
n(Ue, tr, "PgDefaultViewBuilderCore");
var ir, sr;
class sa extends (sr = Ue, ir = l, sr) {
  as(e) {
...
n(sa, ir, "PgViewBuilder");
var nr, rr;
class na extends (rr = Ue, nr = l, rr) {
  constructor(t, s, o) {
    super(t, o);
    n(this, "columns");
    this.columns = qe(ea(t, s));
  }
  existing() {
    return new Proxy(
      new ie({
...
n(_e, or, "PgMaterializedViewBuilderCore");
var ar, lr;
class ra extends (lr = _e, ar = l, lr) {
  as(e) {
    typeof e == "function" && (e = e(new Ee()));
    const t = new L({
      alias: this.name,
...
n(ra, ar, "PgMaterializedViewBuilder");
var ur, cr;
class oa extends (cr = _e, ur = l, cr) {
  constructor(t, s, o) {
    super(t, o);
    n(this, "columns");
    this.columns = qe(ea(t, s));
...
n(oa, ur, "PgManualMaterializedViewBuilder");
var dr, hr, fr;
class ie extends (fr = re, hr = l, dr = Ge, fr) {
...
var mr, gr, pr;
class se extends (pr = re, gr = l, mr = He, pr) {
  constructor({ pgConfig: t, config: s }) {
    super(s);
    n(this, mr);
    this[He] = {
...
n(se, gr, "PgMaterializedView");
function Al(i, e, t) {
  return e ? new na(i, e, t) : new sa(i, t);
}
function zl(i, e, t) {
  return e ? new oa(i, e, t) : new ra(i, t);
}
function Il(i) {
  return h(i, ie);
}
