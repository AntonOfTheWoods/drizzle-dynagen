...
function Be() {
  return be || (be = 1, function(A, d) {
    (function() {
      var y, $, q, M, v, j, w, b, W, ue, T, te, X, ne, m;
      q = Math.floor, ue = Math.min, $ = function(i, h) {
        ...
        i.push = j, i.pop = v, i.replace = b, i.pushpop = w, i.heapify = M, i.updateItem = X, i.nlargest = T, i.nsmallest = te;
        function i(h) {
...
function Ie() {
  return Me || (Me = 1, (function() {
    var A, d, y, $, q, M, v, j, w, b, W, ue, T, te, X, ne, m, i, h, a, _, S = [].indexOf;
    ({ floor: X, max: m, min: i } = Math), d = Ce(), T = Ne, j = function(o, t) {
      return t ? 2 * o / t : 1;
    }, v = function(o, t) {
      var e, n, s, r, l;
      ...
      _chainB() {
        ...
        }), g = /* @__PURE__ */ new Map(), p = t.length, this.autojunk && p >= 200 && (x = X(p / 100) + 1, e.forEach(function(k, O) {
          if (k.length > x)
      ...
      findLongestMatch(t, e, n, s) {
        var r, l, f, u, c, p, x, g, k, O, R, z, K, C, E, D, P, N;
        for ([r, l, f, g] = [this.a, this.b, this.b2j, this.isbjunk], [u, c, p] = [t, n, 0], O = {}, x = K = P = t, N = e; P <= N ? K < N : K > N; x = P <= N ? ++K : --K) {
          for (D = {}, R = [], f.has(r[x]) && (R = f.get(r[x])), E = 0, C = R.length; E < C; E++)
            if (k = R[E], !(k < n)) {
              if (k >= s)
                break;
              z = D[k] = (O[k - 1] || 0) + 1, z > p && ([u, c, p] = [x - z + 1, k - z + 1, z]);
            }
          O = D;
        }
      ...
      getMatchingBlocks() {
        var t, e, n, s, r, l, f, u, c, p, x, g, k, O, R, z, K, C, E, D, P;
      ...
      getGroupedOpcodes(t = 3) {
        var e, n, s, r, l, f, u, c, p, x, g;
        for (e = this.getOpcodes(), e.length || (e = [["equal", 0, 1, 0, 1]]), e[0][0] === "equal" && ([g, r, l, f, u] = e[0], e[0] = [g, m(r, l - t), l, m(f, u - t), u]), e[e.length - 1][0] === "equal" && ([g, r, l, f, u] = e[e.length - 1], e[e.length - 1] = [g, r, i(l, r + t), f, i(u, f + t)]), x = t + t, s = [], n = [], c = 0, p = e.length; c < p; c++)
          [g, r, l, f, u] = e[c], g === "equal" && l - r > x && (n.push([g, r, i(l, r + t), f, i(u, f + t)]), s.push(n), n = [], [r, f] = [m(r, l - t), m(f, u - t)]), n.push([g, r, l, f, u]);
      ...
      quickRatio() {
        var t, e, n, s, r, l, f, u, c, p, x;
        if (!this.fullbcount)
          for (this.fullbcount = n = {}, p = this.b, s = 0, r = p.length; s < r; s++)
            e = p[s], n[e] = (n[e] || 0) + 1;
        for (n = this.fullbcount, t = {}, u = 0, x = this.a, f = 0, l = x.length; f < l; f++)
          e = x[f], ue(t, e) ? c = t[e] : c = n[e] || 0, t[e] = c - 1, c > 0 && u++;
      ...
      /*
      	    ...
      	    */
      compare(t, e) {
        var n, s, r, l, f, u, c, p, x, g, k, O, R, z;
      ...
      _plainReplace(t, e, n, s, r, l) {
        var f, u, c, p, x, g, k, O, R, z;
        for (T(e < n && r < l), l - r < n - e ? (f = this._dump("+", s, r, l), z = this._dump("-", t, e, n)) : (f = this._dump("-", t, e, n), z = this._dump("+", s, r, l)), k = [], R = [f, z], c = 0, p = R.length; c < p; c++)
          for (u = R[c], O = 0, x = u.length; O < x; O++)
            g = u[O], k.push(g);
        return k;
      }
      _fancyReplace(t, e, n, s, r, l) {
        var f, u, c, p, x, g, k, O, R, z, K, C, E, D, P, N, oe, G, I, H, Q, V, Y, ie, ee, re, se, L, U, B, fe, le, F, Z, ge, he, _e, ce, ve, ke, ye, $e, qe, ae, we;
        for ([k, P] = [0.74, 0.75], D = new q(this.charjunk), [N, oe] = [
          null,
          null
        ...
        if ([f, g] = [t[O], s[R]], N === null) {
          for (x = E = "", D.setSeqs(f, g), ye = D.getOpcodes(), F = 0, ee = ye.length; F < ee; F++)
          ...
          for ($e = this._qformat(f, g, x, E), Z = 0, re = $e.length; Z < re; Z++)
            L = $e[Z], U.push(L);
        } else
          U.push("  " + f);
...
`), l;
      ...
      var u, c, p, x, g, k, O, R, z, K, C, E, D, P, N, oe, G, I, H, Q, V, Y, ie, ee, re, se, L, U, B;
...
`), I = [], L = !1, ie = new q(null, o, t).getGroupedOpcodes(), K = 0, E = ie.length; K < E; K++)
        for (g = ie[K], L || (L = !0, x = s ? `	${s}` : "", B = r ? `	${r}` : "", I.push(`--- ${e}${x}${f}`), I.push(`+++ ${n}${B}${f}`)), [p, C] = [g[0], g[g.length - 1]], u = W(p[1], C[2]), c = W(p[3], C[4]), I.push(`@@ -${u} +${c} @@${f}`), H = 0, D = g.length; H < D; H++) {
          if ([U, k, O, R, z] = g[H], U === "equal") {
            for (ee = o.slice(k, O), Q = 0, P = ee.length; Q < P; Q++)
              G = ee[Q], I.push(" " + G);
            continue;
          }
      ...
      var u, c, p, x, g, k, O, R, z, K, C, E, D, P, N, oe, G, I, H, Q, V, Y, ie, ee, re, se, L, U, B, fe;
      for (e == null && (e = ""), n == null && (n = ""), s == null && (s = ""), r == null && (r = ""), l == null && (l = 3), f == null && (f = `
`), ie = {
        insert: "+ ",
        delete: "- ",
        ...
        if (k = re[C], !U) {
          if (U = !0, g = s ? `	${s}` : "", fe = r ? `	${r}` : "", H.push(`*** ${e}${g}${f}`), H.push(`--- ${n}${fe}${f}`), [x, E] = [k[0], k[k.length - 1]], H.push("***************" + f), c = b(x[1], E[2]), H.push(`*** ${c} ****${f}`), M(function() {
            var le, F, Z;
          ...
          if (p = b(x[3], E[4]), H.push(`--- ${p} ----${f}`), M(function() {
            var le, F, Z;
            for (Z = [], F = 0, le = k.length; F < le; F++)
...
class Je {
  ...
  objectDiff(d, y) {
    ...
    for (const [v, j] of Object.entries(d))
      if (!this.options.outputNewOnly) {
        const w = "__deleted";
        !(v in y) && !this.options.excludeKeys.includes(v) && ($[`${v}${w}`] = j, q -= 30, M = !1);
      }
    for (const [v, j] of Object.entries(y)) {
      const w = this.options.outputNewOnly ? "" : "__added";
      !(v in d) && !this.options.excludeKeys.includes(v) && ($[`${v}${w}`] = j, q -= 30, M = !1);
    }
    for (const [v, j] of Object.entries(d))
      if (v in y) {
        if (this.options.excludeKeys.includes(v))
          continue;
        q += 20;
        const w = y[v], b = this.diff(j, w);
        b.equal ? (this.options.full || this.options.outputKeys.includes(v)) && ($[v] = j) : ($[v] = b.result, M = !1), q += Math.min(20, Math.max(-10, b.score / 5));
      }
  ...
  findMatchingObject(d, y, $) {
    let q = null;
    for (const [M, { item: v, index: j }] of Object.entries($))
      if (M !== "__next") {
  ...
  scalarize(d, y, $) {
    ...
    if ($) {
      ...
      for (let j = 0; j < d.length; j++) {
        ...
        b && (!v[b.key] || b.score > v[b.key].score) && (v[b.key] = { score: b.score, index: j });
      }
  ...
  arrayDiff(d, y) {
    ...
    const j = new Le.SequenceMatcher(null, q, v).getOpcodes();
    let w = [], b = 0, W = !0;
  ...
  diff(d, y) {
    ...
    let M = 100, v = d, j;
    return this.options.keysOnly ? (j = !0, v = void 0) : ($ === "date" && q === "date" ? j = d.getTime() === y.getTime() : j = d === y, j ? this.options.full || (v = void 0) : (M = 0, this.options.outputNewOnly ? v = y : v = { __old: d, __new: y })), { score: M, result: v, equal: j };
  }
}
function Ve(A, d, y = {}) {
