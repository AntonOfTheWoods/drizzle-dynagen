...
test("array #1: empty array default", async () => {
  const from = {
    test: pgTable("test", {
...
test("array #2: integer array default", async () => {
  const from = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
    }),
...
test("array #3: bigint array default", async () => {
  const from = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
    }),
  ...
  const to = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
      values: bigint("values", { mode: "bigint" })
        .array()
        .default([BigInt(1), BigInt(2), BigInt(3)]),
    }),
  };
...
test("array #4: boolean array default", async () => {
  const from = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
    }),
...
test("array #5: multi-dimensional array default", async () => {
  const from = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
    }),
...
test("array #6: date array default", async () => {
  const from = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
    }),
...
test("array #7: timestamp array default", async () => {
  const from = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
    }),
  ...
  const to = {
    test: pgTable("test", {
      ...
      values: timestamp("values")
        .array()
        .default([new Date("2024-08-06"), new Date("2024-08-07")]),
    }),
  };
...
test("array #8: json array default", async () => {
  const from = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
    }),
...
test("array #9: text array default", async () => {
  const from = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
    }),
...
test("array #10: uuid array default", async () => {
  const from = {
    test: pgTable("test", {
      id: serial("id").primaryKey(),
    }),
...
test("array #11: enum array default", async () => {
...
test("array #12: enum empty array default", async () => {
  const testEnum = pgEnum("test_enum", ["a", "b", "c"]);
