...
test("create role with properties", async () => {
  const schema1 = {};
...
test("create role with some properties", async () => {
  const schema1 = {};
...
test("create and drop role", async () => {
  const schema1 = {
    manager: pgRole("manager"),
  };
...
test("rename role", async () => {
  ...
  expect(statements).toStrictEqual([{ nameFrom: "manager", nameTo: "admin", type: "rename_role" }]);
});

test("alter all role field", async () => {
  const schema1 = {
    manager: pgRole("manager"),
  };
...
test("alter createdb in role", async () => {
  const schema1 = {
    manager: pgRole("manager"),
  };
...
test("alter createrole in role", async () => {
  const schema1 = {
    manager: pgRole("manager"),
  };
...
test("alter inherit in role", async () => {
  const schema1 = {
    manager: pgRole("manager"),
  };
