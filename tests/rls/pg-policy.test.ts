...
test("add policy + enable rls", async () => {
  const schema1 = {
    users: pgTable("users", {
...
test("drop policy + disable rls", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
...
test("add policy without enable rls", async () => {
  ...
  expect(sqlStatements).toStrictEqual(['CREATE POLICY "newRls" ON "users" AS PERMISSIVE FOR ALL TO public;']);
  expect(statements).toStrictEqual([
    {
      data: {
        as: "PERMISSIVE",
...
test("drop policy without disable rls", async () => {
  ...
  expect(sqlStatements).toStrictEqual(['DROP POLICY "oldRls" ON "users" CASCADE;']);
  expect(statements).toStrictEqual([
    {
      data: {
        as: "PERMISSIVE",
...
test("alter policy without recreation: changing roles", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "users" TO current_role;']);
  expect(statements).toStrictEqual([
    {
...
test("alter policy without recreation: changing using", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "users" TO public USING (true);']);
  expect(statements).toStrictEqual([
    {
...
test("alter policy without recreation: changing with check", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "users" TO public WITH CHECK (true);']);
  expect(statements).toStrictEqual([
    {
...
test("alter policy with recreation: changing as", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
...
test("alter policy with recreation: changing for", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
...
test('alter policy with recreation: changing both "as" and "for"', async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
...
test("alter policy with recreation: changing all fields", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
...
test("rename policy", async () => {
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "users" RENAME TO "newName";']);
  expect(statements).toStrictEqual([
    {
      newName: "newName",
      oldName: "test",
...
test("rename policy in renamed table", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
...
test("create table with a policy", async () => {
  const schema1 = {};
  ...
  expect(statements).toStrictEqual([
    {
      ...
      checkConstraints: [],
      compositePkName: "",
      policies: ["test--PERMISSIVE--ALL--public--undefined--undefined--undefined"],
      schema: "",
      tableName: "users2",
      isRLSEnabled: false,
      type: "create_table",
...
test("drop table with a policy", async () => {
  const schema1 = {
    users: pgTable(
      "users2",
      {
  ...
  expect(sqlStatements).toStrictEqual(['DROP POLICY "test" ON "users2" CASCADE;', 'DROP TABLE "users2" CASCADE;']);
  expect(statements).toStrictEqual([
    {
      policies: ["test--PERMISSIVE--ALL--public--undefined--undefined--undefined"],
      schema: "",
...
test('add policy with multiple "to" roles', async () => {
  const schema1 = {
    users: pgTable("users", {
      id: integer("id").primaryKey(),
    }),
...
test("create table with rls enabled", async () => {
  const schema1 = {};
...
test("drop policy with enabled rls", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
  ...
  expect(sqlStatements).toStrictEqual(['DROP POLICY "test" ON "users" CASCADE;']);
});

test("add policy with enabled rls", async () => {
  const schema1 = {
    users: pgTable("users", {
      id: integer("id").primaryKey(),
    }).enableRLS(),
...
test("add policy + link table", async () => {
  const schema1 = {
    users: pgTable("users", {
      id: integer("id").primaryKey(),
    }),
...
test("drop policy with link", async () => {
  const users = pgTable("users", {
    id: integer("id").primaryKey(),
  });
...
test("add policy in table and with link table", async () => {
  const schema1 = {
    users: pgTable("users", {
      id: integer("id").primaryKey(),
    }),
...
test("link non-schema table", async () => {
  const users = pgTable("users", {
    id: integer("id").primaryKey(),
  });
  ...
  expect(sqlStatements).toStrictEqual(['CREATE POLICY "test" ON "public"."users" AS PERMISSIVE FOR ALL TO public;']);
  expect(statements).toStrictEqual([
    {
      data: {
        as: "PERMISSIVE",
...
test("unlink non-schema table", async () => {
  const users = pgTable("users", {
    id: integer("id").primaryKey(),
  });
  ...
  expect(sqlStatements).toStrictEqual(['DROP POLICY "test" ON "public"."users" CASCADE;']);
  expect(statements).toStrictEqual([
    {
      data: {
        as: "PERMISSIVE",
...
test("add policy + link non-schema table", async () => {
  const schema1 = {
    users: pgTable("users", {
      id: integer("id").primaryKey(),
    }),
...
test("add policy + link non-schema table from auth schema", async () => {
  const schema1 = {
    users: pgTable("users", {
      id: integer("id").primaryKey(),
    }),
...
test("rename policy that is linked", async () => {
  const users = pgTable("users", {
    id: integer("id").primaryKey(),
  });
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "public"."users" RENAME TO "newName";']);
  expect(statements).toStrictEqual([
    {
      newName: "newName",
      oldName: "test",
...
test("alter policy that is linked", async () => {
  const users = pgTable("users", {
    id: integer("id").primaryKey(),
  });
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "public"."users" TO current_role;']);
  expect(statements).toStrictEqual([
    {
      newData: {
        as: "PERMISSIVE",
...
test("alter policy that is linked: withCheck", async () => {
  const users = pgTable("users", {
    id: integer("id").primaryKey(),
  });
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "public"."users" TO public WITH CHECK (false);']);
  expect(statements).toStrictEqual([
    {
      newData: {
        as: "PERMISSIVE",
...
test("alter policy that is linked: using", async () => {
  const users = pgTable("users", {
    id: integer("id").primaryKey(),
  });
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "public"."users" TO public USING (false);']);
  expect(statements).toStrictEqual([
    {
      newData: {
        as: "PERMISSIVE",
...
test("alter policy in the table", async () => {
  const schema1 = {
    users: pgTable(
      "users",
      {
...
test("alter policy in the table: withCheck", async () => {
  // const users = pgTable("users", {
  //   id: integer("id").primaryKey(),
  // });
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "users" TO public WITH CHECK (false);']);
  expect(statements).toStrictEqual([
    {
...
test("alter policy in the table: using", async () => {
  // const users = pgTable("users", {
  //   id: integer("id").primaryKey(),
  // });
  ...
  expect(sqlStatements).toStrictEqual(['ALTER POLICY "test" ON "users" TO public USING (false);']);
  expect(statements).toStrictEqual([
    {
