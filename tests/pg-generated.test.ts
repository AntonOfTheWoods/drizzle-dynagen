...
test("generated as callback: add column with generated constraint", async () => {
  ...
  const to = {
    users: pgTable("users", {
      ...
      id2: integer("id2"),
      name: text("name"),
      generatedName: text("gen_name").generatedAlwaysAs((): SQL => sql`${to.users.name} || 'hello'`),
    }),
  };
...
test("generated as callback: drop generated constraint", async () => {
  const from = {
    users: pgTable("users", {
      ...
      id2: integer("id2"),
      name: text("name"),
      generatedName: text("gen_name").generatedAlwaysAs((): SQL => sql`${from.users.name} || 'to delete'`),
    }),
  };
  const to = {
    users: pgTable("users", {
...
test("generated as callback: change generated constraint", async () => {
  const from = {
    users: pgTable("users", {
      ...
      id2: integer("id2"),
      name: text("name"),
      generatedName: text("gen_name").generatedAlwaysAs((): SQL => sql`${from.users.name}`),
    }),
  };
  const to = {
    users: pgTable("users", {
...
test("generated as sql: add column with generated constraint", async () => {
  ...
  const to = {
    users: pgTable("users", {
      ...
      id2: integer("id2"),
      name: text("name"),
      generatedName: text("gen_name").generatedAlwaysAs(sql`\"users\".\"name\" || 'hello'`),
    }),
  };
...
test("generated as sql: drop generated constraint", async () => {
  const from = {
    users: pgTable("users", {
      ...
      id2: integer("id2"),
      name: text("name"),
      generatedName: text("gen_name").generatedAlwaysAs(sql`\"users\".\"name\" || 'to delete'`),
    }),
  };
  const to = {
    users: pgTable("users", {
...
test("generated as string: add column with generated constraint", async () => {
  ...
  const to = {
    users: pgTable("users", {
      ...
      id2: integer("id2"),
      name: text("name"),
      generatedName: text("gen_name").generatedAlwaysAs(`"users"."name" || 'hello'`),
    }),
  };
...
test("generated as string: add generated constraint to an exisiting column", async () => {
  ...
  const to = {
    users: pgTable("users", {
      ...
      id2: integer("id2"),
      name: text("name"),
      generatedName: text("gen_name").notNull().generatedAlwaysAs(`"users"."name" || 'to add'`),
    }),
  };
...
test("generated as string: drop generated constraint", async () => {
  const from = {
    users: pgTable("users", {
      ...
      id2: integer("id2"),
      name: text("name"),
      generatedName: text("gen_name").generatedAlwaysAs(`"users"."name" || 'to delete'`),
    }),
  };
  const to = {
    users: pgTable("users", {
