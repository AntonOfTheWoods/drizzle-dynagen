...
test("add table #7", async () => {
  ...
  const { statements } = await diffTestSchemas(from, to, ["public.users1->public.users2"]);
...
test("multiproject schema alter table name #1", async () => {
  ...
  const { statements } = await diffTestSchemas(from, to, ["public.prefix_users->public.prefix_users1"]);
...
test("change table schema #1", async () => {
  ...
  const { statements } = await diffTestSchemas(from, to, ["public.users->folder.users"]);
...
test("change table schema #2", async () => {
  ...
  const { statements } = await diffTestSchemas(from, to, ["folder.users->public.users"]);
...
test("change table schema #3", async () => {
  ...
  const { statements } = await diffTestSchemas(from, to, ["folder1.users->folder2.users"]);
...
test("change table schema #5", async () => {
  ...
  const { statements } = await diffTestSchemas(from, to, ["folder1.users->folder2.users2"]);
...
test("change table schema #6", async () => {
  ...
  const { statements } = await diffTestSchemas(from, to, ["folder1->folder2", "folder2.users->folder2.users2"]);
...
test("optional db aliases (snake case)", async () => {
  ...
  const { sqlStatements } = await diffTestSchemas(from, to, [], "snake_case");
...
test("optional db aliases (camel case)", async () => {
  ...
  const { sqlStatements } = await diffTestSchemas(from, to, [], "camelCase");
